...
/**
   ...
   The Blake2b_256 algorithm takes an arbitrary data stream, known as
   the message (up to \f$2^{256}\f$ bits in length) and outputs a
   condensed 256 bit (32 byte) representation of that data
   stream, known as the message digest. The Blake2b_256 algorithm is
   considered secure in that it is considered computationally
   infeasible to find the message that produced the message
   digest. For more information on Blake2b_256, see https://blake2.net/.

   The Blake2b_512 algorithm takes an arbitrary data stream, known as
   the message (up to \f$2^{512}\f$ bits in length) and outputs a
   condensed 512 bit (64 byte) representation of that data
   stream, known as the message digest. The Blake2b_512 algorithm is
   considered secure in that it is considered computationally
   infeasible to find the message that produced the message
   digest. For more information on Blake2b_512, see https://blake2.net/.
*/
