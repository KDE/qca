...
MACRO(SETUP_QT_DIRS)
  ...
  execute_process(COMMAND ${QMAKE_EXECUTABLE} -query QT_INSTALL_LIBS OUTPUT_VARIABLE QT_LIBRARY_DIR OUTPUT_STRIP_TRAILING_WHITESPACE)
  execute_process(COMMAND ${QMAKE_EXECUTABLE} -query QT_INSTALL_PREFIX OUTPUT_VARIABLE QT_PREFIX_DIR OUTPUT_STRIP_TRAILING_WHITESPACE)
  execute_process(COMMAND ${QMAKE_EXECUTABLE} -query QT_INSTALL_PLUGINS OUTPUT_VARIABLE QT_PLUGINS_DIR OUTPUT_STRIP_TRAILING_WHITESPACE)
  execute_process(COMMAND ${QMAKE_EXECUTABLE} -query QT_INSTALL_BINS OUTPUT_VARIABLE QT_BINARY_DIR OUTPUT_STRIP_TRAILING_WHITESPACE)
  execute_process(COMMAND ${QMAKE_EXECUTABLE} -query QT_INSTALL_HEADERS OUTPUT_VARIABLE QT_HEADERS_DIR OUTPUT_STRIP_TRAILING_WHITESPACE)
  execute_process(COMMAND ${QMAKE_EXECUTABLE} -query QT_INSTALL_DOCS OUTPUT_VARIABLE QT_DOC_DIR OUTPUT_STRIP_TRAILING_WHITESPACE)
  execute_process(COMMAND ${QMAKE_EXECUTABLE} -query QT_INSTALL_DATA OUTPUT_VARIABLE QT_DATA_DIR OUTPUT_STRIP_TRAILING_WHITESPACE)
  execute_process(COMMAND ${QMAKE_EXECUTABLE} -query QT_HOST_DATA OUTPUT_VARIABLE QT_ARCHDATA_DIR OUTPUT_STRIP_TRAILING_WHITESPACE)
